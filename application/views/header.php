...
<head>
    ...
    <!-- Bootstrap 4 -->
    <link href="<?=base_url()?>application/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?=base_url()?>application/assets/css/mantenimientos.css" rel="stylesheet" type="text/css">

    <script src="<?=base_url()?>application/assets/jQuery/jquery-1.12.1.min.js"></script>
    <script type="text/javascript" src="<?=base_url()?>application/assets/bootstrap/js/bootstrap.min.js"></script>
    ...
    <script src="<?=base_url()?>application/libraries/mantenimientos.js"></script>
</head>
<body>
